...
class Design456_SelectionGate:
    ...
    def GetResources(self):
        return{
            'Pixmap':    ICON_PATH + '2D_Drawing.svg',
            'MenuText': '2Ddrawing',
            'ToolTip':  '2Ddrawing'
        }
...
class GateSelect0:
    ...
    def GetResources(self):
        return {
            'Pixmap': ICON_PATH + 'SelectionModeBody.svg',
...
class GateSelect1:
    ...
    def GetResources(self):
        return {
            'Pixmap': ICON_PATH + 'SelectionModeFace.svg',
...
class GateSelect2:
    ...
    def GetResources(self):
        return {
            'Pixmap': ICON_PATH + 'SelectionModeEdges.svg',
...
class GateSelect3:
    ...
    def GetResources(self):
        return {
            'Pixmap': ICON_PATH + 'SelectionModeVertex.svg',
