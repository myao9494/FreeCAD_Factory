...
class BIM_Reextrude:
    ...
    def GetResources(self):
        ...
        return {'Pixmap'  : os.path.join(os.path.dirname(__file__),"icons","BIM_Reextrude.svg"),
                'MenuText': QT_TRANSLATE_NOOP("BIM_Reextrude", "Reextrude"),
                'ToolTip' : QT_TRANSLATE_NOOP("BIM_Reextrude", "Recreates an extruded Structure from a selected face"),
               }
