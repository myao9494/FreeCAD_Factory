...
def makeArchPart(name="Ground Floor", over_level=None, height=3000):
    ...
    _tip = 'Describe.'
    obj.addProperty('App::PropertyLinkGlobal', 'OverLevel', 
                    'Level properties', 
                    _tip)
    obj.OverLevel = over_level

    _tip = 'Describe.'
    obj.addProperty('App::PropertyLength', 'OverLevelOffset', 
                    'Level properties', 
                    _tip)

    _tip = 'Describe.'
    obj.addProperty('App::PropertyLength', 'LevelHeight', 
                    'Level properties', 
                    _tip)
    obj.LevelHeight = height

    if obj.OverLevel:
        obj.Placement.Base.z = obj.OverLevel.Placement.Base.z + obj.OverLevel.LevelHeight
