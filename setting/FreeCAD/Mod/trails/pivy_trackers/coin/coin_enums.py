...
class NodeSearch(Const):
    ...
    FIRST = coin.SoSearchAction.FIRST
    LAST = coin.SoSearchAction.LAST
    ALL = coin.SoSearchAction.ALL
...
class NodeTypes(Const):
    ...
    type_id = lambda class_type: class_type.getClassTypeId()
