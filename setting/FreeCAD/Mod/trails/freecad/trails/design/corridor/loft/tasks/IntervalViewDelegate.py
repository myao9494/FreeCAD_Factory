...
class IntervalViewDelegate(QtGui.QStyledItemDelegate):
    ...
    def createEditor(self, parent, option, index):
        ...
        return super(IntervalViewDelegate, self).createEditor(parent, option, index)
    ...
    def setModelData(self, editor, model, index):
        ...
        super(IntervalViewDelegate, self).setModelData(editor, model, index)
