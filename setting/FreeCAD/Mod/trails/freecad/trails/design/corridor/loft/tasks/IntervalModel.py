...
class IntervalModel(QtCore.QAbstractTableModel):
    """
    ...
    def validate_station(value):
        ...
        rex = IntervalModel.rex_station.match(value)

        #if not, look for a nearly correct form
        if rex is None:

            rex = IntervalModel.rex_near_station.match(value)
            ...
            value = IntervalModel.fixup_station(sta)
